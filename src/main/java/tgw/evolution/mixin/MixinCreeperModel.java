...
public abstract class MixinCreeperModel<T extends Entity> extends HierarchicalModel<T> implements LegacyHMCreeper<T> {

    @Shadow @Final private ModelPart head;
    @Mutable @Shadow @Final private ModelPart leftFrontLeg;
    @Mutable @Shadow @Final private ModelPart leftHindLeg;
    @Mutable @Shadow @Final private ModelPart rightFrontLeg;
    @Mutable @Shadow @Final private ModelPart rightHindLeg;
