...
public abstract class MixinAbsoptionMobEffect extends MobEffect {

    public MixinAbsoptionMobEffect(MobEffectCategory p_19451_, int p_19452_) {
    ...
    public void addAttributeModifiers(LivingEntity entity, AttributeMap attributes, int lvl) {
        ((PatchLivingEntity) entity).addAbsorptionSuggestion(4 * (lvl + 1));
    ...
    public void removeAttributeModifiers(LivingEntity entity, AttributeMap attributes, int lvl) {
        ((PatchLivingEntity) entity).removeAbsorptionSuggestion(4 * (lvl + 1));
