...
public abstract class ControlsScreenMixin extends OptionsSubScreen {
    ...
    private static final CycleOption<Boolean> TOGGLE_CRAWL = CycleOption.createBinaryOption("key.crawl",
                                                                                            new TranslatableComponent("options.key.toggle"),
                                                                                            new TranslatableComponent("options.key.hold"),
                                                                                            op -> ((IOptionsPatch) op).getToggleCrawl(),
                                                                                            (op, op1, value) -> ((IOptionsPatch) op).setToggleCrawl(
                                                                                                    value));

    public ControlsScreenMixin(Screen pLastScreen,
                               Options pOptions,
                               Component pTitle) {
