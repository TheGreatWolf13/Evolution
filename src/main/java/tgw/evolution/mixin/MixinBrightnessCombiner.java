...
public abstract class MixinBrightnessCombiner<S extends BlockEntity> {
    ...
    public Int2IntFunction acceptDouble(S first, S second) {
        return light -> {
            ...
            int i = LevelRenderer.getLightColor(first.getLevel(), pos1.getX(), pos1.getY(), pos1.getZ());
            BlockPos pos2 = second.getBlockPos();
            //noinspection ConstantConditions
            int j = LevelRenderer.getLightColor(second.getLevel(), pos2.getX(), pos2.getY(), pos2.getZ());
