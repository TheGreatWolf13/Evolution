...
public abstract class MixinSkeletonModel<T extends Mob & RangedAttackMob> extends HumanoidModel<T> implements LegacyHMSkeleton<T> {

    public MixinSkeletonModel(ModelPart pRoot) {
        super(pRoot);
    }
