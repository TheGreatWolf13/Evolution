...
public abstract class MixinModelPart_Cube implements PatchCube {

    @Final @Shadow public float maxX;
    @Final @Shadow public float maxY;
    @Final @Shadow public float maxZ;
    @Final @Shadow public float minX;
    @Final @Shadow public float minY;
    @Final @Shadow public float minZ;
    @Final @Shadow public ModelPart.Polygon[] polygons;
