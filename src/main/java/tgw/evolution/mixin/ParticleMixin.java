...
public abstract class ParticleMixin {
    ...
    @Shadow private static @Final AABB INITIAL_AABB;
    @Shadow private static @Final double MAXIMUM_COLLISION_VELOCITY_SQUARED;
    @Shadow protected float bbHeight;
    @Shadow protected float bbWidth;
    @Shadow protected boolean hasPhysics;
    @Shadow protected @Final ClientLevel level;
