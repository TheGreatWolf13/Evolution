...
public abstract class MixinEntityRenderers {
    ...
    @Mutable @Shadow @Final private static Map<String, EntityRendererProvider<AbstractClientPlayer>> PLAYER_PROVIDERS;
    ...
    @Redirect(method = "<clinit>",
            at = @At(value = "INVOKE", target = "Lcom/google/common/collect/ImmutableMap;of(Ljava/lang/Object;" +
                                                "Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)" +
                                                "Lcom/google/common/collect/ImmutableMap;", remap = false))
    private static @Nullable <K, V>

    ImmutableMap<String, EntityRendererProvider<AbstractClientPlayer>> onClinitRemoveMap(K k1, V v1, K k2, V v2) {
        return null;
    }
}
