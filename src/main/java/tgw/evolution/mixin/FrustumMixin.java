...
@Mixin(Frustum.class)
public abstract class FrustumMixin implements IFrustumPatch {

    @Shadow private double camX;
    @Shadow private double camY;
    @Shadow private double camZ;
    @Shadow private @Final Vector4f[] frustumData;
     ...
     */
    @Overwrite
    public void calculateFrustum(Matrix4f proj, Matrix4f frustum) {
    ...
    @Shadow public abstract boolean cubeInFrustum(double pMinX, double pMinY, double pMinZ, double pMaxX, double pMaxY, double pMaxZ);
