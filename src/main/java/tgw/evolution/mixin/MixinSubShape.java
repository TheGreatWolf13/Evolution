...
public abstract class MixinSubShape extends DiscreteVoxelShape {

    @Shadow @Final private int endX;
    @Shadow @Final private int endY;
    @Shadow @Final private int endZ;
    @Shadow @Final private int startX;
    @Shadow @Final private int startY;
    @Shadow @Final private int startZ;

    public MixinSubShape(int pXSize, int pYSize, int pZSize) {
