...
public abstract class MixinPauseScreen extends Screen {
    ...
    private void createPauseMenu() {
        ...
        y += 24;
        this.addRenderableWidget(new Button(xLeft, y, 98, 20, new TranslatableComponent("gui.advancements"), b -> this.minecraft.setScreen(new ScreenAdvancements(this.minecraft.player.connection.getAdvancements()))));
        this.addRenderableWidget(new Button(xMiddle, y, 98, 20, new TranslatableComponent("gui.stats"), b -> this.minecraft.setScreen(new ScreenStats(this.minecraft.player.getStats()))));
        y += 24;
        ...
        y += 24;
        this.addRenderableWidget(new Button(xLeft, y, 98, 20, new TranslatableComponent("menu.options"), b -> this.minecraft.setScreen(new OptionsScreen(this, this.minecraft.options))));
        this.addRenderableWidget(new Button(xMiddle, y, 98, 20, new TranslatableComponent("evolution.gui.evolution"), b -> this.minecraft.setScreen(new ScreenEvolution(this, false))));
        Component quit = this.minecraft.isLocalServer() ? new TranslatableComponent("menu.returnToMenu") : new TranslatableComponent("menu.disconnect");
        y += 24;
