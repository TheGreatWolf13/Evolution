...
public abstract class MixinOptionsList extends ContainerObjectSelectionList<OptionsList.Entry> {

    public MixinOptionsList(Minecraft pMinecraft, int pWidth, int pHeight, int pY0, int pY1, int pItemHeight) {
     ...
     */
    @Overwrite
    public @Nullable AbstractWidget findOption(Option option) {
