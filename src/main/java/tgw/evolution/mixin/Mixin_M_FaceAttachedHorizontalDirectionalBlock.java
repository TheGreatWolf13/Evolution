...
public abstract class Mixin_M_FaceAttachedHorizontalDirectionalBlock extends HorizontalDirectionalBlock {

    public Mixin_M_FaceAttachedHorizontalDirectionalBlock(Properties properties) {
        super(properties);
    }
