...
public class StoneAge implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        Advancement root = Advancement.Builder.advancement()
                                              .display(EvolutionBlocks.COBBLESTONES.get(RockVariant.ANDESITE),
        ...
        Advancement defARock = Advancement.Builder.advancement()
                                                  ...
                                                  .display(new TagDisplayInfo(EvolutionItemTags.ROCKS,
                                                                              new TranslatableComponent("evolution.advancements.stone_age.definitely_a_rock.title"),
                                                                              new TranslatableComponent("evolution.advancements.stone_age.definitely_a_rock.description"),
                                                                              null,
                                                                              FrameType.TASK,
                                                                              true,
                                                                              true,
                                                  ...
                                                  .addCriterion("has_any_rock", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(EvolutionItemTags.ROCKS).build()))
                                                  .save(consumer, "evolution:stone_age/definitely_a_rock");
        Advancement knapping = Advancement.Builder.advancement()
                                                  .parent(defARock)
                                                  .display(EvolutionItems.PART_HEAD.newStack(PartTypes.Head.AXE, EvolutionMaterials.ANDESITE),
