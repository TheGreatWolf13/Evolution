...
import tgw.evolution.datagen.util.ModelBuilder;
...
public abstract class ModelProvider<T extends ModelBuilder<T>> implements EvolutionDataProvider<ResourceLocation> {
    ...
    public ModelProvider(DataGenerator generator, Collection<Path> existingPaths, ExistingFileHelper existingFileHelper, String modId, String folder, Function<ResourceLocation, T> factory) {
    ...
    public ModelProvider(DataGenerator generator, Collection<Path> existingPaths, ExistingFileHelper existingFileHelper, String modid, String folder, BiFunction<ResourceLocation, ExistingFileHelper, T> builderFromModId) {
        this(generator, existingPaths, existingFileHelper, modid, folder, loc -> builderFromModId.apply(loc, existingFileHelper));
    }
    ...
    protected static String name(Item block) {
        return Registry.ITEM.getKey(block).getPath();
    }
