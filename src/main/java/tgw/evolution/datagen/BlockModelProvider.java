...
public class BlockModelProvider extends ModelProvider<BlockModelBuilder> {
    ...
    protected void registerModels() {
        ...
        this.getBuilder("evolution:planks_up")
            ...
            .from(0, 14, 0)
            .to(16, 16, 16)
            .face(Direction.NORTH).uvs(0, 0, 16, 2).texture("#block").cullface(Direction.NORTH).end()
            .face(Direction.EAST).uvs(0, 0, 16, 2).texture("#block").cullface(Direction.EAST).end()
            .face(Direction.SOUTH).uvs(0, 0, 16, 2).texture("#block").cullface(Direction.SOUTH).end()
            .face(Direction.WEST).uvs(0, 0, 16, 2).texture("#block").cullface(Direction.WEST).end()
        ...
        this.getBuilder("evolution:planks_north")
            ...
            .face(Direction.EAST).uvs(14, 0, 16, 16).texture("#block").cullface(Direction.EAST).end()
            .face(Direction.SOUTH).uvs(0, 0, 16, 16).texture("#block").end()
            .face(Direction.WEST).uvs(0, 0, 2, 16).texture("#block").cullface(Direction.WEST).end()
            .face(Direction.UP).uvs(0, 0, 16, 2).texture("#block").cullface(Direction.UP).end()
            .face(Direction.DOWN).uvs(0, 14, 16, 16).texture("#block").cullface(Direction.DOWN).end()
            .end();
        this.getBuilder("evolution:planks_west")
            .element()
            .from(0, 0, 0)
            .to(2, 16, 16)
            .face(Direction.NORTH).uvs(14, 0, 16, 16).texture("#block").cullface(Direction.NORTH).end()
            .face(Direction.EAST).uvs(0, 0, 16, 16).texture("#block").end()
            .face(Direction.SOUTH).uvs(0, 0, 2, 16).texture("#block").cullface(Direction.SOUTH).end()
            .face(Direction.WEST).uvs(0, 0, 16, 16).texture("#block").cullface(Direction.WEST).end()
            .face(Direction.UP).uvs(0, 0, 2, 16).texture("#block").cullface(Direction.UP).end()
            .face(Direction.DOWN).uvs(0, 0, 2, 16).texture("#block").cullface(Direction.DOWN).end()
            .end();
        this.getBuilder("evolution:planks_down")
            .element()
            .from(0, 0, 0)
            .to(16, 2, 16)
            .face(Direction.NORTH).uvs(0, 14, 16, 16).texture("#block").cullface(Direction.NORTH).end()
            .face(Direction.EAST).uvs(0, 14, 16, 16).texture("#block").cullface(Direction.EAST).end()
            .face(Direction.SOUTH).uvs(0, 14, 16, 16).texture("#block").cullface(Direction.SOUTH).end()
            .face(Direction.WEST).uvs(0, 14, 16, 16).texture("#block").cullface(Direction.WEST).end()
        ...
        this.getBuilder("evolution:planks_east")
            ...
            .from(14, 0, 0)
            .to(16, 16, 16)
            .face(Direction.NORTH).uvs(0, 0, 2, 16).texture("#block").cullface(Direction.NORTH).end()
            .face(Direction.EAST).uvs(0, 0, 16, 16).texture("#block").cullface(Direction.EAST).end()
            .face(Direction.SOUTH).uvs(14, 0, 16, 16).texture("#block").cullface(Direction.SOUTH).end()
            .face(Direction.WEST).uvs(0, 0, 16, 16).texture("#block").end()
            .face(Direction.UP).uvs(14, 0, 16, 16).texture("#block").cullface(Direction.UP).end()
            .face(Direction.DOWN).uvs(14, 0, 16, 16).texture("#block").cullface(Direction.DOWN).end()
            .end();
        this.getBuilder("evolution:planks_south")
            ...
            .face(Direction.EAST).uvs(0, 0, 2, 16).texture("#block").cullface(Direction.EAST).end()
            .face(Direction.SOUTH).uvs(0, 0, 16, 16).texture("#block").cullface(Direction.SOUTH).end()
            .face(Direction.WEST).uvs(14, 0, 16, 16).texture("#block").cullface(Direction.WEST).end()
            .face(Direction.UP).uvs(0, 14, 16, 16).texture("#block").cullface(Direction.UP).end()
            .face(Direction.DOWN).uvs(0, 0, 16, 2).texture("#block").cullface(Direction.DOWN).end()
            .end();
    }
}
