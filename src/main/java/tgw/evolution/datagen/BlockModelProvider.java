...
//import static net.minecraftforge.client.model.generators.ModelBuilder.FaceRotation.COUNTERCLOCKWISE_90;
//
//public class BlockModelProvider extends ModelProvider<BlockModelBuilder> {
//
//    public BlockModelProvider(GenBundle bundle) {
//        this(bundle, Evolution.MODID, BLOCK_FOLDER, BlockModelBuilder::new);
//    }
//
//    public BlockModelProvider(GenBundle bundle,
//                              String modId,
//                              String folder,
//                              BiFunction<ResourceLocation, ExistingFileHelper, BlockModelBuilder> factory) {
//        super(bundle, modId, folder, factory);
//    }
//
//    @Override
...
//            .end();
//        this.getBuilder("evolution:block/dry_grass")
...
//            .face(Direction.UP).uvs(0.0f, 0.0f, 16.0f, 16.0f).texture("#top").cullface(Direction.UP).end()
//            .face(Direction.DOWN).uvs(0.0f, 0.0f, 16.0f, 16.0f).texture("#bottom").cullface(Direction.DOWN).end()
//            .end()
//            .element()
//            .from(0.0f, 0.0f, 0.0f)
//            .to(16.0f, 16.0f, 16.0f)
//            .face(Direction.UP).uvs(0.0f, 0.0f, 16.0f, 16.0f).texture("#upover").cullface(Direction.UP).tintindex(0).end()
...
//            .end();
//        this.getBuilder("evolution:block/dry_grass_snow")
//            .parent(this.getExistingFile(new ResourceLocation("block/block")))
//            .element()
//            .from(0.0f, 0.0f, 0.0f)
//            .to(16.0f, 16.0f, 16.0f)
...
//            .from(0.0f, 0.0f, 0.0f)
//            .to(16.0f, 16.0f, 16.0f)
//            .face(Direction.EAST).uvs(0.0f, 0.0f, 16.0f, 16.0f).texture("#overlay").cullface(Direction.EAST).end()
//            .face(Direction.SOUTH).uvs(0.0f, 0.0f, 16.0f, 16.0f).texture("#overlay").cullface(Direction.SOUTH).end()
//            .face(Direction.NORTH).uvs(0.0f, 0.0f, 16.0f, 16.0f).texture("#overlay").cullface(Direction.NORTH).end()
//            .face(Direction.WEST).uvs(0.0f, 0.0f, 16.0f, 16.0f).texture("#overlay").cullface(Direction.WEST).end()
//            .end();
...
//            .face(Direction.WEST).uvs(0.0f, 0.0f, 16.0f, 16.0f).texture("#overlay").cullface(Direction.WEST).tintindex(0).end()
//            .end();
//        this.getBuilder("evolution:block/grass_snow")
//            .parent(this.getExistingFile(new ResourceLocation("block/block")))
//            .element()
//            .from(0.0f, 0.0f, 0.0f)
//            .to(16.0f, 16.0f, 16.0f)
