...
//    }
//
//    public static void startGeneration(ResourceLocation spawnPool,
//                                       int size,
//                                       PuzzleManager.IPieceFactory pieceFactory,
...
//
//        StructurePuzzlePiece create(TemplateManager manager,
...
//
//        public Assembler(ResourceLocation spawnPool,
//                         int size,
//                         PuzzleManager.IPieceFactory pieceFactory,
//                         ChunkGenerator chunkGenerator,
//                         TemplateManager manager,
...
//            PuzzlePattern pool = REGISTRY.get(spawnPool);
//            PuzzlePiece chosenSpawnPiece = pool.getRandomPiece(rand);
//            StructurePuzzlePiece structure = pieceFactory.create(manager,
//                                                                 chosenSpawnPiece,
//                                                                 pos,
//                                                                 chosenSpawnPiece.groundLevelDelta(),
//                                                                 chosenRotation,
//                                                                 chosenSpawnPiece.getBoundingBox(manager, pos, chosenRotation));
...
//            int surfaceY = chunkGenerator.getHeight(middleX, middleZ, Heightmap.Type.WORLD_SURFACE_WG);
...
//                    int surfaceY = this.chunkGenerator.getHeight(middleX, middleZ, Heightmap.Type.OCEAN_FLOOR_WG);
...
//            BlockPos.Mutable matchingCornerPos = new BlockPos.Mutable();
...
//                PuzzlePattern targetPool = REGISTRY.get(new ResourceLocation(puzzleBlock.nbt.getString("TargetPool")));
//                PuzzlePattern fallbackPool = REGISTRY.get(targetPool.getFallbackPool());
...
//                            List<Template.BlockInfo> candidatePuzzleBlocks = candidatePiece.getPuzzleBlocks(this.templateManager,
//                                                                                                            BlockPos.ZERO,
//                                                                                                            candidateRotation,
//                                                                                                            this.rand);
...
//                                    matchingCornerPos.setPos(connectionPos.getX() - matchingPuzzleBlockRelativePos.getX(),
//                                                             connectionPos.getY() - matchingPuzzleBlockRelativePos.getY(),
//                                                             connectionPos.getZ() - matchingPuzzleBlockRelativePos.getZ());
//                                    MutableBoundingBox matchingBB = candidatePiece.getBoundingBox(this.templateManager,
//                                                                                                  matchingCornerPos,
//                                                                                                  candidateRotation);
...
//                                    int heightDelta = relativePuzzleBlockYPos - matchingPuzzleBlockRelativePosY +
//                                                      puzzleBlock.state.get(BlockPuzzle.FACING).getYOffset();
...
//                                            surfaceYForPuzzleBlock = this.chunkGenerator.getHeight(puzzleBlockPos.getX(),
//                                                                                                   puzzleBlockPos.getZ(),
...
//                                    MutableBoundingBox actualMachingBB = matchingMinYDelta == 0 ?
//                                                                         matchingBB :
//                                                                         matchingBB.func_215127_b(0, matchingMinYDelta, 0);
...
//                                        }
//                                        StructurePuzzlePiece matchingStructure = this.pieceFactory.create(this.templateManager,
//                                                                                                          candidatePiece,
//                                                                                                          actualMatchingCornerPos,
//                                                                                                          matchingGroundLevelDelta,
//                                                                                                          candidateRotation,
//                                                                                                          actualMachingBB);
//                                        int junctionPosY;
//                                        if (isPlacingRigid) {
...
//                                        }
//                                        structurePiece.addJunction(new PuzzleJunction(connectionPos.getX(),
//                                                                                      junctionPosY - relativePuzzleBlockYPos +
//                                                                                      placingGroundLevelDelta,
//                                                                                      connectionPos.getZ(),
//                                                                                      heightDelta,
//                                                                                      matchingProjection));
//                                        matchingStructure.addJunction(new PuzzleJunction(puzzleBlockPos.getX(),
//                                                                                         junctionPosY - matchingPuzzleBlockRelativePosY +
//                                                                                         matchingGroundLevelDelta,
//                                                                                         puzzleBlockPos.getZ(),
//                                                                                         -heightDelta,
//                                                                                         placingProjection));
