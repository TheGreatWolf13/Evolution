...
//        INBT map = NBTHelper.createMap(ImmutableMap.of(new StringNBT("Danger"), new FloatNBT(this.danger), new StringNBT("CivType"), new ByteNBT
//        (this.civType.getId()), new StringNBT("Mega"), new ByteNBT((byte) (this.isMega ? 1 : 0))));
