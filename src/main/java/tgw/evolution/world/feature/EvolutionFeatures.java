...
public final class EvolutionFeatures {
    ...
    //Features
    public static final RegistryObject<Feature<NoFeatureConfig>> TREE_BIRCH = FEATURES.register("tree_birch",
                                                                                                () -> new AspenTreeFeature(NoFeatureConfig::deserialize,
                                                                                                                           false,
                                                                                                                           EvolutionBlocks.LOG_BIRCH.get()
                                                                                                                                                    .getDefaultState()
                                                                                                                                                    .with(TREE,
                                                                                                                                                          true),
                                                                                                                           EvolutionBlocks.LEAVES_BIRCH
                                                                                                                                   .get()
                                                                                                                                   .getDefaultState(),
                                                                                                                           2));
    public static final RegistryObject<Feature<NoFeatureConfig>> TREE_BIG_OAK = FEATURES.register("tree_big_oak",
                                                                                                  () -> new BigTreeFeature(NoFeatureConfig::deserialize,
                                                                                                                           false));
    public static final RegistryObject<Feature<NoFeatureConfig>> TREE_OAK = FEATURES.register("tree_oak",
                                                                                              () -> new TreeFeature(NoFeatureConfig::deserialize,
                                                                                                                    false));
