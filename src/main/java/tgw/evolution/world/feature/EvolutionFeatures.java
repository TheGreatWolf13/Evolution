...
public class EvolutionFeatures {
    ...
    public static final RegistryObject<Feature<NoFeatureConfig>> ROCK = FEATURES.register("rock", () -> new RockFeature(NoFeatureConfig::deserialize));
    public static final RegistryObject<Feature<NoFeatureConfig>> STRATA = FEATURES.register("strata", () -> new StrataFeature(NoFeatureConfig::deserialize));
