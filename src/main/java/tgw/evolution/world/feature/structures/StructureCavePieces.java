...
public class StructureCavePieces {
    ...
    static {
        ...
        PuzzleManager.REGISTRY.register(new PuzzlePattern(SUP, new ResourceLocation("empty"), ImmutableList.of(Pair.of(new SinglePuzzlePiece("evolution:sup_normal1"), 1), Pair.of(new SinglePuzzlePiece("evolution:sup_tribal1"), 1)), PlacementType.RIGID));
