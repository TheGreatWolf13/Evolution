...
//                                                          CORRIDOR_END,
//                                                          ImmutableList.of(Pair.of(new ConfiguredPuzzlePiece("evolution:test/straight",
//                                                          UNDERGROUND),
//                                                                                   80),
...
//                                                                           Pair.of(new ConfiguredPuzzlePiece("evolution:test/six_room",
//                                                                           UNDERGROUND),
//                                                                                   20),
...
//                                                          Evolution.getResource("empty"),
//                                                          ImmutableList.of(Pair.of(new ConfiguredPuzzlePiece("evolution:test/door_locked", SOFT),
//                                                          1),
