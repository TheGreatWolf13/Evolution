...
public class StructureTestPieces {
    ...
    static {
        ...
        PuzzleManager.REGISTRY.register(new PuzzlePattern(CORRIDORS_POOL, CORRIDOR_END, ImmutableList.of(Pair.of(new UndergroundPuzzlePiece("evolution:test/straight"), 100), Pair.of(new UndergroundPuzzlePiece("evolution:test/door_locked"), 10), Pair.of(new UndergroundPuzzlePiece("evolution:test/l_room"), 20), Pair.of(new UndergroundPuzzlePiece("evolution:test/six_room"), 20), Pair.of(new UndergroundPuzzlePiece("evolution:test/hole_down_lock"), 10), Pair.of(new UndergroundPuzzlePiece("evolution:test/hole_up_lock"), 10)), PuzzlePattern.PlacementBehaviour.RIGID));
