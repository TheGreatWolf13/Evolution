...
//
//public abstract class EntityGenericAnimal extends EntityGenericAgeable {
//
...
//
//    protected EntityGenericAnimal(EntityType<? extends EntityGenericAnimal> type, Level level) {
//        super(type, level);
...
//        if (itemstack.getItem() == EvolutionItems.DEBUG_ITEM) {
