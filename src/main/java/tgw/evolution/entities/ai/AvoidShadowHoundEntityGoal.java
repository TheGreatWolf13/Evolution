...
public class AvoidShadowHoundEntityGoal<T extends LivingEntity> extends Goal {
    ...
    public AvoidShadowHoundEntityGoal(EntityShadowHound entityIn, Class<T> avoidClass, Predicate<LivingEntity> targetPredicate, float distance, double nearSpeedIn, double farSpeedIn, Predicate<LivingEntity> p_i48859_9_) {
    ...
    public boolean shouldExecute() {
        ...
        this.avoidTarget = this.entity.world.func_225318_b(this.classToAvoid, this.builtTargetSelector, this.entity, this.entity.posX, this.entity.posY, this.entity.posZ, this.entity.getBoundingBox().grow(this.avoidDistance, 3.0D, this.avoidDistance));
