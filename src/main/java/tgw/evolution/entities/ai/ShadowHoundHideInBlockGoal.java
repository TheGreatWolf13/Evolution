...
//        return !this.shadowHound.isDead() && this.shadowHound.hideCooldown <= 0 && (this.shadowHound.world.getDayTime() % 24000 >= 23000 || this
//        .shadowHound.world.getDayTime() % 24000 <= 13000);
//    }
//
//    @Override
//    public void tick() {
