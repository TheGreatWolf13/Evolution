...
public class LookRandomlyGoal extends Goal {
	...
	public LookRandomlyGoal(CreatureEntity entitylivingIn) {
	...
	public void tick() {
		--this.idleTime;
		this.entity.getLookController().setLookPosition(this.entity.posX + this.lookX, this.entity.posY + this.entity.getEyeHeight(), this.entity.posZ + this.lookZ);
	}
}