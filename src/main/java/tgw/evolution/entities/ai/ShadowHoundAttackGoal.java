...
//        }
//        return this.attacker.isWithinHomeDistanceFromPosition(new BlockPos(livingentity)) && (!(livingentity instanceof PlayerEntity) ||
...
//        --this.delayCounter;
//        if ((this.longMemory || this.attacker.getEntitySenses().canSee(livingentity)) && this.delayCounter <= 0 && (this.targetX == 0.0D && this
//        .targetY == 0.0D && this.targetZ == 0.0D || livingentity.getDistanceSq(this.targetX, this.targetY, this.targetZ) >= 1.0D || this.attacker
