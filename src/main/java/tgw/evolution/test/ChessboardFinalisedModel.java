...
public class ChessboardFinalisedModel implements IBakedModel {
    private final int numberOfChessPieces;
    private final IBakedModel parentModel;

    public ChessboardFinalisedModel(IBakedModel parentModel, int numberOfChessPieces) {
     ...
     */
    private static int calculatePackedNormal(float x1,
                                             float y1,
                                             float z1,
                                             float x2,
                                             float y2,
     ...
     */
    private static BakedQuad createBakedQuadForFace(float centreLR,
                                                    float width,
                                                    float centreUD,
                                                    float height,
    ...
    private static List<BakedQuad> getChessPiecesQuads(int numberOfPieces) {
        ...
        List<BakedQuad> returnList = new ArrayList<>(64);
        ...
        for (int i = 0; i < numberOfPieces; ++i) {
            float columnCentrePosition = (col + 0.5F) / PIECES_PER_ROW;
            float rowCentrePosition = (row + 0.5F) / NUMBER_OF_ROWS;
            ...
            BakedQuad nextPieceFront = createBakedQuadForFace(columnCentrePosition,
                                                              PIECE_WIDTH,
                                                              rowCentrePosition,
                                                              PIECE_HEIGHT,
                                                              ...
                                                              chessPieceTexture,
                                                              Direction.SOUTH);
            BakedQuad nextPieceBack = createBakedQuadForFace(columnCentrePosition,
                                                             PIECE_WIDTH,
                                                             rowCentrePosition,
                                                             PIECE_HEIGHT,
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, Random rand) {
        ...
        List<BakedQuad> combinedQuadsList = new ArrayList<>(this.parentModel.getQuads(state, null, rand));
        combinedQuadsList.addAll(getChessPiecesQuads(this.numberOfChessPieces));
