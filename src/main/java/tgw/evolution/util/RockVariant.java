...
public enum RockVariant {
    ...
    public static RockVariant fromId(byte id) {
        ...
        throw new IllegalStateException("Unknown variant for id: " + id);
    }
    ...
    public Item getAxeHead() {
        ...
        throw new IllegalStateException("Unknown RockVariant: " + this);
    }
    ...
    public ItemStack getKnappedStack(EnumKnapping knapping) {
        switch (knapping) {
            ...
            case KNIFE:
                return new ItemStack(this.getKnifeBlade(), 2);
            case HAMMER:
