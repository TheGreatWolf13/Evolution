...
public enum EnumRockVariant {
    ANDESITE(0,
             ...
             DRY_GRASS_ANDESITE,
             axe_head_andesite,
             javelin_head_andesite,
             shovel_head_andesite,
             hammer_head_andesite,
             hoe_head_andesite,
             knife_blade_andesite,
             GRAVEL_ANDESITE,
             STONE_BRICKS_ANDESITE,
             SAND_ANDESITE),
    BASALT(1,
           "basalt",
           STONE_BASALT,
    ...
    CONGLOMERATE(4,
                 ...
                 COBBLE_CONGLOMERATE,
                 ROCK_CONGLOMERATE,
                 KNAPPING_CONGLOMERATE,
                 DIRT_CONGLOMERATE,
                 GRASS_CONGLOMERATE,
                 DRY_GRASS_CONGLOMERATE,
                 axe_head_conglomerate,
                 javelin_head_conglomerate,
                 shovel_head_conglomerate,
                 hammer_head_conglomerate,
                 hoe_head_conglomerate,
                 knife_blade_conglomerate,
                 GRAVEL_CONGLOMERATE,
                 STONE_BRICKS_CONGLOMERATE,
                 SAND_CONGLOMERATE),
    DACITE(5,
           "dacite",
           STONE_DACITE,
    ...
    DIORITE(6,
            ...
            DRY_GRASS_DIORITE,
            axe_head_diorite,
            javelin_head_diorite,
            shovel_head_diorite,
            hammer_head_diorite,
            hoe_head_diorite,
            knife_blade_diorite,
            GRAVEL_DIORITE,
            STONE_BRICKS_DIORITE,
            SAND_DIORITE),
    DOLOMITE(7,
             "dolomite",
             STONE_DOLOMITE,
             ...
             DRY_GRASS_DOLOMITE,
             axe_head_dolomite,
             javelin_head_dolomite,
             shovel_head_dolomite,
             hammer_head_dolomite,
             hoe_head_dolomite,
             knife_blade_dolomite,
             GRAVEL_DOLOMITE,
             STONE_BRICKS_DOLOMITE,
             SAND_DOLOMITE),
    GABBRO(8,
           "gabbro",
           STONE_GABBRO,
    ...
    LIMESTONE(11,
              ...
              DRY_GRASS_LIMESTONE,
              axe_head_limestone,
              javelin_head_limestone,
              shovel_head_limestone,
              hammer_head_limestone,
              hoe_head_limestone,
              knife_blade_limestone,
              GRAVEL_LIMESTONE,
              STONE_BRICKS_LIMESTONE,
              SAND_LIMESTONE),
    MARBLE(12,
           "marble",
           STONE_MARBLE,
    ...
    PHYLLITE(13,
             ...
             DRY_GRASS_PHYLLITE,
             axe_head_phyllite,
             javelin_head_phyllite,
             shovel_head_phyllite,
             hammer_head_phyllite,
             hoe_head_phyllite,
             knife_blade_phyllite,
             GRAVEL_PHYLLITE,
             STONE_BRICKS_PHYLLITE,
             SAND_PHYLLITE),
    QUARTZITE(14,
              "quartzite",
              STONE_QUARTZITE,
              ...
              DRY_GRASS_QUARTZITE,
              axe_head_quartzite,
              javelin_head_quartzite,
              shovel_head_quartzite,
              hammer_head_quartzite,
              hoe_head_quartzite,
              knife_blade_quartzite,
              GRAVEL_QUARTZITE,
    ...
    RED_SANDSTONE(15,
                  "red_sandstone",
                  STONE_RED_SANDSTONE,
                  COBBLE_RED_SANDSTONE,
                  ROCK_RED_SANDSTONE,
                  KNAPPING_RED_SANDSTONE,
                  DIRT_RED_SANDSTONE,
                  GRASS_RED_SANDSTONE,
                  DRY_GRASS_RED_SANDSTONE,
                  axe_head_red_sandstone,
                  javelin_head_red_sandstone,
                  shovel_head_red_sandstone,
                  hammer_head_red_sandstone,
                  hoe_head_red_sandstone,
    ...
    SANDSTONE(16,
              ...
              DRY_GRASS_SANDSTONE,
              axe_head_sandstone,
              javelin_head_sandstone,
              shovel_head_sandstone,
              hammer_head_sandstone,
              hoe_head_sandstone,
              knife_blade_sandstone,
              GRAVEL_SANDSTONE,
              STONE_BRICKS_SANDSTONE,
              SAND_SANDSTONE),
    SCHIST(17,
           "schist",
           STONE_SCHIST,
    ...
    EnumRockVariant(int id,
                    String name,
                    @Nullable RegistryObject<Block> stone,
                    @Nullable RegistryObject<Block> cobble,
                    @Nullable RegistryObject<Block> rock,
                    @Nullable RegistryObject<Block> knapping,
                    RegistryObject<Block> dirt,
                    RegistryObject<Block> grass,
                    @Nullable RegistryObject<Block> dryGrass,
                    @Nullable RegistryObject<Item> axeHead,
                    @Nullable RegistryObject<Item> javelinHead,
                    @Nullable RegistryObject<Item> shovelHead,
                    @Nullable RegistryObject<Item> hammerHead,
                    @Nullable RegistryObject<Item> hoeHead,
                    @Nullable RegistryObject<Item> knifeBlade,
                    @Nullable RegistryObject<Block> gravel,
                    @Nullable RegistryObject<Block> stoneBricks,
                    @Nullable RegistryObject<Block> sand) {
        this.id = (byte) id;
        this.name = name;
    ...
    public static EnumRockVariant fromId(byte id) {
        for (EnumRockVariant variant : values()) {
            if (variant.id == id) {
                return variant;
            }
        }
