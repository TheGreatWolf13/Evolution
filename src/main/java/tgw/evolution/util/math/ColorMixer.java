...
public final class ColorMixer {
    ...
    private static final long MASK1 = 0x00FF_00FF;
    private static final long MASK2 = 0xFF00_FF00;
    ...
    public static long mixARGB(long c1, long c2, int f1, int f2) {
        return (c1 & MASK1) * f1 + (c2 & MASK1) * f2 >> 8 & MASK1 | (c1 & MASK2) * f1 + (c2 & MASK2) * f2 >> 8 & MASK2;
    }
