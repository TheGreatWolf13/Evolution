...
public class DirectionDiagonalList {
    ...
    public void addFromDirection(Direction direction) {
        switch (direction) {
            ...
            default -> throw new IllegalArgumentException("Only directions on the XZ plane are supported for this operation!");
        }
    }
    ...
    public DirectionDiagonal getRandomAndRemove(RandomGenerator random) {
        if (this.current == 0) {
