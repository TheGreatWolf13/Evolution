...
public interface I2LMap extends Int2LongMap, MapEv {
    ...
    @UnmodifiableView I2LMap view();

    class EmptyMap extends Int2LongMaps.EmptyMap implements I2LMap {
        ...
        @Override
        public @UnmodifiableView I2LMap view() {
            return this;
        }
    }

    class Singleton extends Int2LongMaps.Singleton implements I2LMap {
    ...
    class View extends Int2LongMaps.UnmodifiableMap implements I2LMap {

        protected final I2LMap m;

        public View(I2LMap m) {
            super(m);
            this.m = m;
        }
