...
public interface O2SMap<K> extends Object2ShortMap<K>, ICollectionExtension {
     ...
     * Entries from the map can be removed during iteration by calling the {@link O2SMap#remove(Object)} method as usual, however, the map will not
    ...
    class Entry<K> {
        ...
        protected Entry<K> set(@Nullable K k, short v) {
            this.k = k;
            this.v = v;
            return this;
        }
