...
public class TESchematic extends TileEntity {
    ...
    public boolean detectSize() {
        ...
        MutableBoundingBox boundingBox = this.calculateEnclosingBoundingBox(pos, relatedCornerBlocks);
        if (boundingBox.maxX - boundingBox.minX > 1 && boundingBox.maxY - boundingBox.minY > 1 && boundingBox.maxZ - boundingBox.minZ > 1) {
            ...
            this.size = new BlockPos(boundingBox.maxX - boundingBox.minX - 1, boundingBox.maxY - boundingBox.minY - 1, boundingBox.maxZ - boundingBox.minZ - 1);
            this.markDirty();
            BlockState state = this.world.getBlockState(pos);
    ...
    private MutableBoundingBox calculateEnclosingBoundingBox(BlockPos startingPos, List<TESchematic> relatedCornerBlocks) {
