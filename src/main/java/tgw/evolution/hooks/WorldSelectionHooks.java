...
//        if (!Files.isDirectory(save.getSavesDir())) {
...
//        File[] potentialWorlds = save.getSavesDir().toFile().listFiles();
...
//                }
//                else {
//                    thirdLine = thirdLine + ", " + I18n.format("selectWorld.version") + " " + TextFormatting.ITALIC + version + TextFormatting
//                    .RESET;
//                }
//            }
//            else {
