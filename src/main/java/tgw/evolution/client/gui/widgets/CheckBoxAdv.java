...
@OnlyIn(Dist.CLIENT)
public class CheckBoxAdv extends Button {

    private static final OnPress ON_PRESS = b -> {
    };
    ...
    public CheckBoxAdv(int xPos, int yPos, Component displayString, boolean isChecked, boolean leftText, OnCheck onCheck) {
        super(xPos, yPos, Minecraft.getInstance().font.width(displayString) + 2 + 11, 11, displayString, ON_PRESS);
    ...
    public CheckBoxAdv(int xPos, int yPos, Component displayString, boolean isChecked, OnCheck onCheck) {
