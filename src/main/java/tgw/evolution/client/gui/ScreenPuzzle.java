...
public class ScreenPuzzle extends Screen {
    ...
    protected void init() {
        ...
        this.doneButton = this.addButton(new Button(this.width / 2 - 4 - 150, 210, 150, 20, I18n.format("gui.done"), button -> this.sendUpdatesToServer()));
    ...
    protected void checkValid() {
        this.doneButton.active = ResourceLocation.isResouceNameValid(this.attachmentTypeText.getText()) & ResourceLocation.isResouceNameValid(this.targetPoolText.getText());
    }
    ...
    public void render(int x, int y, float partialTicks) {
        ...
        this.drawString(this.font, I18n.format("evolution.puzzle.target_pool"), this.width / 2 - 153, 30, 10526880);
        this.targetPoolText.render(x, y, partialTicks);
        this.drawString(this.font, I18n.format("evolution.puzzle.attachment_type"), this.width / 2 - 153, 70, 10526880);
        this.attachmentTypeText.render(x, y, partialTicks);
        this.drawString(this.font, I18n.format("evolution.puzzle.final_state"), this.width / 2 - 153, 110, 10526880);
        this.finalStateText.render(x, y, partialTicks);
        this.drawString(this.font, I18n.format("evolution.puzzle.checkBB"), this.width / 2 - 153, 150, 10526880);
