...
//            this.button = new Button(10, 5, 44, 20, new TextComponent(this.getLabel()).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting
//            .WHITE),
//                                     onPress -> {
...
//                return objects -> new IArrayList((Iterator<Integer>) objects);
//            }
