...
//                        ScreenModConfigSelection.this.renderTooltip(poseStack,
//                                                                    Minecraft.getInstance().font.split(ScreenModConfigSelection.this
//                                                                    .textNoPermission,
//                                                                                                       Math.max(ScreenModConfigSelection.this
//                                                                                                       .width /
...
//                                                                          for (Pair<ForgeConfigSpec.ConfigValue<?>, ForgeConfigSpec.ValueSpec>
//                                                                          pair : this.allConfigValues) {
