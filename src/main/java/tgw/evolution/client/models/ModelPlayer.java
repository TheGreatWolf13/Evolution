...
public class ModelPlayer<T extends LivingEntity> extends ModelHumanoid<T> implements HMPlayer<T> {
    ...
    public static MeshDefinition createMesh(CubeDeformation def, boolean slim) {
        ...
        root.addOrReplaceChild("cape", CubeListBuilderEv.create().requestFix()
                                                        .texOffs(0, 0)
                                                        .addBox(-5, -16, 0, 10, 16, 1, def, 1, 0.5F), PartPose.offset(0, 24, 2));
        PartDefinition jacket = root.addOrReplaceChild("clothes_body", CubeListBuilderEv.create().requestFix()
                                                                                        .texOffs(16, 32)
                                                                                        .addBox(-4, -12, -2, 8, 12, 4, clothesDef),
        ...
        if (slim) {
            ...
            PartDefinition armL = body.addOrReplaceChild("arm_l", CubeListBuilderEv.create()
                                                                                   .texOffs(32, 48)
                                                                                   .addBoxBend(-2, -4, -2, 3, 6, 4, def, true), leftArmPoint);
            armL.addOrReplaceChild("forearm_l", CubeListBuilderEv.create().texOffs(32, 54).addBoxBend(-2, -6, -2, 3, 6, 4, def, false),
                                   leftForearmPoint);
            PartDefinition armR = body.addOrReplaceChild("arm_r", CubeListBuilderEv.create()
                                                                                   .texOffs(40, 16)
                                                                                   .addBoxBend(-1, -4, -2, 3, 6, 4, def, true), rightArmPoint);
            armR.addOrReplaceChild("forearm_r", CubeListBuilderEv.create().texOffs(40, 22).addBoxBend(-1, -6, -2, 3, 6, 4, def, false),
                                   rightForearmPoint);
            PartDefinition clothesArmL = jacket.addOrReplaceChild("clothes_arm_l",
                                                                  CubeListBuilderEv.create()
                                                                                   .texOffs(48, 48)
                                                                                   .addBoxBend(-2, -4, -2, 3, 6, 4, clothesDef, true), leftArmPoint);
            clothesArmL.addOrReplaceChild("clothes_forearm_l",
                                          CubeListBuilderEv.create().texOffs(48, 52).addBoxBend(-2, -6, -2, 3, 6, 4, clothesDef, false),
                                          leftForearmPoint);
            PartDefinition clothesArmR = jacket.addOrReplaceChild("clothes_arm_r",
                                                                  CubeListBuilderEv.create()
                                                                                   .texOffs(40, 32)
                                                                                   .addBoxBend(-1, -4, -2, 3, 6, 4, clothesDef, true), rightArmPoint);
            clothesArmR.addOrReplaceChild("clothes_forearm_r",
                                          CubeListBuilderEv.create().texOffs(40, 38).addBoxBend(-1, -6, -2, 3, 6, 4, clothesDef, false),
                                          rightForearmPoint);
        }
        else {
            ...
            PartDefinition armL = body.addOrReplaceChild("arm_l", CubeListBuilderEv.create()
                                                                                   .texOffs(32, 48)
                                                                                   .addBoxBend(-3, -4, -2, 4, 6, 4, def, true), leftArmPoint);
            armL.addOrReplaceChild("forearm_l", CubeListBuilderEv.create().texOffs(32, 54).addBoxBend(-2, -6, -2, 4, 6, 4, def, false),
                                   leftForearmPoint);
            PartDefinition clothesArmL = jacket.addOrReplaceChild("clothes_arm_l",
                                                                  CubeListBuilderEv.create()
                                                                                   .texOffs(48, 48)
                                                                                   .addBoxBend(-3, -4, -2, 4, 6, 4, clothesDef, true), leftArmPoint);
            clothesArmL.addOrReplaceChild("clothes_forearm_l",
                                          CubeListBuilderEv.create().texOffs(48, 54).addBoxBend(-2, -6, -2, 4, 6, 4, clothesDef, false),
                                          leftForearmPoint);
            PartDefinition clothesArmR = jacket.addOrReplaceChild("clothes_arm_r",
                                                                  CubeListBuilderEv.create()
                                                                                   .texOffs(40, 32)
                                                                                   .addBoxBend(-1, -4, -2, 4, 6, 4, clothesDef, true), rightArmPoint);
            clothesArmR.addOrReplaceChild("clothes_forearm_r",
                                          CubeListBuilderEv.create().texOffs(40, 38).addBoxBend(-2, -6, -2, 4, 6, 4, clothesDef, false),
                                          rightForearmPoint);
        }
        PartPose leftLegPoint = PartPose.offset(-1.9F, -12, 0);
        PartPose kneePoint = PartPose.offset(0, -6, 0);
        PartDefinition legL = body.addOrReplaceChild("leg_l",
                                                     CubeListBuilderEv.create().texOffs(16, 48).addBoxBend(-2, -6, -2, 4, 6, 4, def, true),
                                                     leftLegPoint);
        legL.addOrReplaceChild("foreleg_l", CubeListBuilderEv.create().texOffs(16, 54).addBoxBend(-2, -6, -2, 4, 6, 4, def, false), kneePoint);
        PartDefinition clothesLegL = jacket.addOrReplaceChild("clothes_leg_l",
                                                              CubeListBuilderEv.create()
                                                                               .texOffs(0, 48)
                                                                               .addBoxBend(-2, -6, -2, 4, 6, 4, clothesDef, true), leftLegPoint);
        clothesLegL.addOrReplaceChild("clothes_foreleg_l",
                                      CubeListBuilderEv.create().texOffs(0, 54).addBoxBend(-2, -6, -2, 4, 6, 4, clothesDef, false), kneePoint);
        PartDefinition clothesLegR = jacket.addOrReplaceChild("clothes_leg_r",
                                                              CubeListBuilderEv.create()
                                                                               .texOffs(0, 32)
                                                                               .addBoxBend(-2, -6, -2, 4, 6, 4, clothesDef, true),
                                                              PartPose.offset(1.9F, -12, 0));
        clothesLegR.addOrReplaceChild("clothes_foreleg_r",
                                      CubeListBuilderEv.create().texOffs(0, 38).addBoxBend(-2, -6, -2, 4, 6, 4, clothesDef, false), kneePoint);
        return mesh;
    }
