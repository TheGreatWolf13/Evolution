...
public class ModelShadowHound extends EntityModel<EntityShadowHound> {
    ...
    @Override
    public void render(EntityShadowHound entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        this.body.render(scale);
        this.head.render(scale);
    }

    @Override
    public void setRotationAngles(EntityShadowHound entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        if (entityIn.isDead()) {
