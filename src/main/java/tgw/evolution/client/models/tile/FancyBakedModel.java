...
//        BlockState mimic = extraData.getData(FancyTile.MIMIC);
//        if (mimic != null) {
...
//        double l = .2;
//        double r = 1 - .2;
//        quads.add(this.createQuad(v(l, r, l), v(l, r, r), v(r, r, r), v(r, r, l), texture));
//        //        quads.add(this.createQuad(v(l, l, l), v(r, l, l), v(r, l, r), v(l, l, r), texture));
//        //        quads.add(this.createQuad(v(r, r, r), v(r, l, r), v(r, l, l), v(r, r, l), texture));
//        //        quads.add(this.createQuad(v(l, r, l), v(l, l, l), v(l, l, r), v(l, r, r), texture));
//        //        quads.add(this.createQuad(v(r, r, l), v(r, l, l), v(l, l, l), v(l, r, l), texture));
//        //        quads.add(this.createQuad(v(l, r, r), v(l, l, r), v(r, l, r), v(r, r, r), texture));
//        return quads;
//    }
//
//    @Override
