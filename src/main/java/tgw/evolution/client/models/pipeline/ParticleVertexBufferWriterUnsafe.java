...
public class ParticleVertexBufferWriterUnsafe extends VertexBufferWriterUnsafe implements IParticleVertexSink {

    public ParticleVertexBufferWriterUnsafe(IVertexBufferView backingBuffer) {
