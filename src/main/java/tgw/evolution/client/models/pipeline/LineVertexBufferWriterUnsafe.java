...
public class LineVertexBufferWriterUnsafe extends VertexBufferWriterUnsafe implements ILineVertexSink {

    public LineVertexBufferWriterUnsafe(IVertexBufferView backingBuffer) {
