...
public class QuadVertexBufferWriterUnsafe extends VertexBufferWriterUnsafe implements IQuadVertexSink {

    public QuadVertexBufferWriterUnsafe(IVertexBufferView backingBuffer) {
