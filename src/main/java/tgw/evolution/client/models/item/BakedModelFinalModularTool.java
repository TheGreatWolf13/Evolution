...
public class BakedModelFinalModularTool implements BakedModel {
    ...
    static {
        Vector3f thirdScale = new Vector3f(0.85f, 0.85f, 0.85f);
        Vector3f thirdTransl = new Vector3f(0, 3 / 16.0f, 1.5f / 16.0f);
        ItemTransform thirdPersonLeft = new ItemTransform(new Vector3f(0, 90, -40), thirdTransl, thirdScale);
        ItemTransform thirdPersonRight = new ItemTransform(new Vector3f(0, -90, 40), thirdTransl, thirdScale);
        Vector3f firstScale = new Vector3f(0.68f, 0.68f, 0.68f);
        Vector3f firstTransl = new Vector3f(1.13f / 16.0f, 3.5f / 16.0f, 1.13f / 16.0f);
        ItemTransform firstPersonLeft = new ItemTransform(new Vector3f(0, 90, -25), firstTransl, firstScale);
        ItemTransform firstPersonRight = new ItemTransform(new Vector3f(0, -90, 25), firstTransl, firstScale);
        ItemTransform head = ItemTransform.NO_TRANSFORM;
        ItemTransform gui = new ItemTransform(new Vector3f(10, 10, 10), new Vector3f(0, 0.5f / 16.0f, 0), new Vector3f(1, 1, 1));
        ItemTransform ground = new ItemTransform(Vector3f.ZERO, new Vector3f(0, 3 / 16.0f, 0), new Vector3f(0.5f, 0.5f, 0.5f));
        ItemTransform fixed = new ItemTransform(new Vector3f(-20, 0, 0), new Vector3f(0, 0, -2.25f / 16.0f), new Vector3f(1.02f, 1.02f, 1.02f));
        TRANSFORMS = new ItemTransforms(thirdPersonLeft, thirdPersonRight, firstPersonLeft, firstPersonRight, head, gui, ground, fixed);
    }
