...
function log(message) {
	print("[evolution/BipedModel Transformer]: " + message);
}
...
function initializeCoreMod() {
	return {
		"Evolution BipedModel Transformer": {
			"target": {
				"type": "CLASS",
...
function patchRotationAngles(instructions) {
	...
	instructions.add(new MethodInsnNode(
		...
		"setRotationAngles",
		"(Lnet/minecraft/client/renderer/entity/model/BipedModel;Lnet/minecraft/entity/LivingEntity;F)V",
		false
	));
